...
class Dataset_finetune_Diff(data.Dataset):
    ...
    def setup(self, path):
        ...
        # oriModel = load_model('../pytorch-cifar/checkpoint_googlenet_normal/ckpt.pth').to(device)
...
def main():
    ...
    # trainset = Dataset_finetune_Diff('2PruningDiffDeepGra_google_rate75/')
    trainset = Dataset_finetune_Diff('2PruningDiffDeepGra_vgg16_rate75/')
    # trainloader = torch.utils.data.DataLoader(
    ...
    for epoch in range(50):
        ...
        if acc > best_acc:
            ...
            if not os.path.isdir('2checkpoint_vgg162_finetune_diff_train_rate75'):
                os.mkdir('2checkpoint_vgg162_finetune_diff_train_rate75')
            torch.save(state, '2checkpoint_vgg162_finetune_diff_train_rate75/ckpt.pth')
            best_acc = acc
    torch.save(state, '2checkpoint_vgg162_finetune_diff_train_rate75/ckpt_final.pth')
